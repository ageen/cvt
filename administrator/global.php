...
require_once(DCPATH.'include/class/templite/class.template.php');
require_once(DCPATH.'include/display.php');
require_once(DCPATH.'include/class/mysql.php');
require_once(DCPATH.'include/class/class.upload.php');
require_once(DCPATH.'include/functions.php');
require_once(DCPATH.'include/fence.php');
//$_GET = add_magic_quotes($_GET);
//$_POST = add_magic_quotes($_POST);
//$_COOKIE = add_magic_quotes($_COOKIE);
$sql = "SELECT * FROM d_config WHERE id = 10";
$d_config = get_rows($sql);
define("IS_MARK", $d_config["is_mark"]);
define("MARK_TEXT", $d_config["mark_text"]);
?>